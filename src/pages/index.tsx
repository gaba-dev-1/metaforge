...
import { TrendingUp, Search, Layers, Trophy, Grid3x3, ChevronDown, ChevronUp, Book, Newspaper, User, Download, Tv } from 'lucide-react';
      ...
      <div className="relative rounded-xl overflow-hidden">
        ...
        <div className="relative z-20 px-6 py-10 flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl font-display mb-3">
            <span className="text-solar-flare">Master</span> <span className="text-white">TeamFight Tactics</span>
          </h2>
