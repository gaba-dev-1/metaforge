    ...
    <>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-6">
          {/* Unified Item Details Section (Recipe removed from here) */}
        ...
        <div className="space-y-6">
          {/* Best Units */}
          {entityData.unitsWithItem && entityData.unitsWithItem.length > 0 && (
            <div className="bg-brown-dark/20 rounded-lg p-4 shadow-md border border-gold/5">
          ...
          {/* Item Combos */}
          {entityData.combos && entityData.combos.length > 0 && (
            <div className="bg-brown-dark/20 rounded-lg p-4 shadow-md border border-gold/5">
              <h2 className="text-lg font-semibold text-gold mb-3">Popular Combos</h2>
              <div className="space-y-3">
                {entityData.combos.slice(0, 4).map((combo, i) => (
                  <div key={i} className="bg-brown-light/40 p-3 rounded hover:bg-gold/15 transition-all shadow-sm">
                    ...
                    <div className="text-xs text-cream/70">
                      {combo.mainItem?.name && `Core: ${combo.mainItem.name}`}
                    </div>
                  </div>
                ))}
              </div>
