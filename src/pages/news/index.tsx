...
const TFTPatchNotes = () => {
  ...
  const [activePatch, setActivePatch] = useState<string>('14.2');
  const [activeTimeline, setActiveTimeline] = useState<string>('patches');
  const [showInfoModal, setShowInfoModal] = useState<boolean>(false);
  
  // Current TFT state based on official data
  ...
  const timelineData: TimelineData = {
    patches: [
      ...
      { 
        ...
        name: "14.4", 
        type: "Content", 
        description: "Revival: Remix Rumble", 
        highlights: ["Set 10 Revival - Remix Rumble", "New Augments", "Opening Encounters"]
      },
      { 
        date: "May 29, 2025", 
        name: "14.5", 
        ...
        highlights: ["Cosmetics simplification", "UX improvements"]
      },
      { 
        date: "June 12, 2025", 
        name: "14.6", 
      ...
      { 
        ...
        highlights: ["New anime/fighting tournament theme", "New mechanics and champions", "Ranked reset"]
      },
      { 
    ...
    sets: [
      ...
      },
      {
        ...
        mechanic: "TBA",
        description: "Anime-themed set with fighting tournament elements"
      },
      {
        name: "Set 16",
    ...
    revivals: [
      {
        ...
        endDate: "TBA",
        description: "Revival of the music-themed Set 10 with new augments and opening encounters"
      }
    ]
  };
  
  // Patch Notes Data - Based on official TFT patch notes
  const patchNotesData: PatchNotesData = {
      ...
      sections: {
        ...
        hacked_encounters: {
          ...
          content: [
            {
              type: "Mecha Minion",
              effect: "Two-star units can appear in your shop!",
              chance: "2.0%"
            }
          ]
        },
        augment_changes: {
          ...
          removed_augments: ["Future Sight", "Tomb Raider", "Cluttered Mind", "Pandora's Bench", "Clear Mind", "NO SCOUT NO PIVOT", "Over Encumbered", "Slammin'", "BRB"],
          returning_augments: ["Fine Vintage", "Starry Night", "Last Stand"],
          adjusted_silver: {},
          adjusted_gold: {},
          adjusted_prismatic: {},
          other_changes: {
        ...
        emblem_changes: {
          title: "Emblem Changes",
          content: [
            {
              name: "Bastion Emblem",
              effect: "Gain 10% of Amor and Magic Resistance as Ability Power"
            },
            {
              name: "Dynamo Emblem",
              effect: "On cast, gain 1% Damage Amp per 15 mana spent"
            },
            {
              name: "Executioner Emblem",
              effect: "Critical Strikes ignore 20% Armor and Magic Resistance"
            },
            {
              name: "Marksman Emblem",
              effect: "Dealing physical damage removes 1 Armor"
            }
          ]
        },
        cosmetics: {
          ...
          content: [
            {
              name: "Portals",
              description: "New cosmetic type that can be equipped and favorited. Available through Rotating Shops and Pass+."
            },
            {
              name: "PROJECT: Chain Vortex Portal",
              description: "Legendary Portal available for three Mythic Medallions."
            },
            {
              name: "Janna's Fantastic Forecast Portal",
              description: "Legendary Portal available for three Mythic Medallions."
            },
            {
              name: "PROJECT: Vayne Unbound",
              description: "Available in Treasure Realms until Patch 14.3."
            },
            {
              name: "Chibi Forecast Janna",
              description: "Available in Treasure Realms and in the Chibi Janna Pass+ Bundle for 2785 RP."
            }
          ]
        },
        ranked: {
    ...
    "14.2": {
      ...
      sections: {
        ...
        bug_fixes: {
          ...
          content: [
            {
              bug: "Gargantuan Resolve",
              fix: "Now works on Ghost Armies."
            },
            {
              bug: "Prismatic Ticket",
              fix: "No longer grants rerolls from Think Fast rerolls."
            },
            {
              bug: "Unstable Evolution",
              fix: "No longer triggers on summons."
            }
          ]
        }
      }
    ...
    "14.4": {
      title: "Revival: Remix Rumble",
      date: "May 14, 2025",
      overview: "Set Revival? More like reunion tour of the century. Remix Rumble is back starting May 14. This patch brings back the popular music-themed set with new Augments and Opening Encounters.",
      keyChanges: [
        {
          title: "Set Revival: Remix Rumble",
          description: "The popular music-themed Set 10 returns with new augments and opening encounters."
        },
        {
          title: "New Augments",
          description: "New Augments have been added to keep the revival fresh and exciting."
        },
        {
          title: "Opening Encounters",
          description: "New Opening Encounters specific to Remix Rumble have been added."
        }
      ],
      sections: {}
    },
    "14.5": {
      title: "Cosmetics Simplification & UX Improvements",
      date: "May 29, 2025",
      overview: "Coming in patch 14.5 we will be simplifying cosmetics tiers and improving our UX.",
      keyChanges: [
        {
          title: "Cosmetics Simplification",
          description: "We're streamlining the cosmetics tiers to make them more intuitive and user-friendly."
        },
        {
          title: "UX Improvements",
          description: "Various user experience improvements across the board to make navigating TFT easier and more enjoyable."
        },
        {
          title: "Balance Adjustments",
          description: "Mid-set balance adjustments to keep the competitive meta healthy."
        }
      ],
      sections: {}
    }
  ...
  const CurrentSetOverview = () => (
    <div className="animate-fadeIn">
      ...
      {/* Content boxes - Replacing the old header "Current Set: Set 14 - Cyber City" */}
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        <div className="flex-1 bg-void-core/15 backdrop-filter backdrop-blur-md rounded-lg p-4 border border-gold/20">
          ...
          <div className="text-sm text-cream/70">Released on {currentTFTData.releaseDate}</div>
        </div>
        ...
        <div className="flex-1 bg-void-core/15 backdrop-blur-md rounded-lg p-4 border border-gold/20">
          ...
          <div className="text-xl font-bold mb-1 text-cream">{currentTFTData.nextSetName}</div>
          <div className="text-sm text-cream/70">Coming on {currentTFTData.nextSetDate}</div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {timelineData.revivals.map((revival, index) => (
                    <div key={index} className="bg-void-core/15 rounded-lg overflow-hidden border border-gold/20">
                      ...
                      <div className="p-4">
                        <div className="mb-3">
                          <span className="text-cream/70 text-sm">Start Date:</span>
                          <div className="text-cream font-medium">{revival.startDate}</div>
                        </div>
                        {revival.endDate !== 'TBA' && (
                          <div className="mb-3">
                            <span className="text-cream/70 text-sm">End Date:</span>
                            <div className="text-cream font-medium">{revival.endDate}</div>
                          </div>
                        )}
                        <div>
                          <span className="text-cream/70 text-sm">Description:</span>
    ...
    <Layout>
      ...
      <div className="container mx-auto py-8">
        ...
        <div className="relative mb-8 overflow-hidden rounded-lg border border-gold/20 shadow-lg">
          ...
          {/* Image background layer - using the same bg.jpg as homepage */}
          <div className="absolute inset-0 bg-[url('/assets/bg.jpg')] bg-cover bg-center opacity-20 z-0"></div>
